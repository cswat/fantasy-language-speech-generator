...
class TranslateForm(forms.Form):
    ...
    #fantasy_language_select = forms.ChoiceField(label=u"Select language:\n", label_suffix='', choices=fantasy_language_options_list)

    #select real languages to combine to help shape fantasy language
    real_language_influences = forms.MultipleChoiceField(label=u"Influences:", choices=real_language_options_list)
    ...
    more_of = forms.CharField(label=u"More of:", max_length=6, required=False, validators=[])
    less_of = forms.CharField(label=u"Less of:", max_length=6, required=False)
    none_of = forms.CharField(label=u"None of:", max_length=6, required=False)
